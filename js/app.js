...
function moreContent(){
  ...
  document.more.appendChild(addBacon);
}
...
var menuItems = ["taro pie", "fries", "ice cream cone"];

function valueMenu(){
  var addValMenu = document.getElementById("menu");
  addValMenu.innerHTML = menuItems;
  document.menu.appendChild(addValMenu);
...
function showPrice(){
  ...
  document.price.appendChild(addPrice);
}
...
document.getElementById("Benjamin").addEventListener("click", addQuote);
